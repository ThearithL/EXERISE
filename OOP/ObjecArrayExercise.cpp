    ...
    do
    {
        ...
        switch(choose)
        {
            ...
            case 1 :{
                ...
                cout<<"|==============================================================|"<<endl;
                cout<<"|Enter the number of book : ";cin>>size_of_book;
                for(i=0;i<size_of_book;i++){
                    cout<<"|Enter Book ID : ";cin>>id;
                    cout<<"|Enter Book Title : ";cin>>title;
                    cout<<"|Enter Book Public : ";cin>>Public_book;
            ...
            case 2 :{
                cout<<"|=============================================================================|"<<endl;
                cout<<"|                           Display all Detail book                           |"<<endl;
                cout<<"|=============================================================================|"<<endl;
                for(i=0;i<size_of_book;i++){
                    cout<<setw(10)<<" ID "
                        <<setw(12)<<" Title "
      ...
      system("pause");
       break;             
            ...
            case 4 :
            {
                ...
                cout<<"|==============================================================|"<<endl;
                cout<<"Enter id to delete: ";cin>>delete_id;
                for(int i=0;i<size_of_book;i++){
        ...
        case 5 :{
                ...
                for(int i=0;i<size_of_book;i++){
                    if(obj[i].getId()== update_id){
                        ...
                        cout<<"Enter New Title: ";cin>>new_title;
                        cout<<"Enter New Public: ";cin>>new_Public_book;
                        cout<<"Enter New Author: ";cin>>new_author;
                        cout<<"Enter New Price: ";cin>>new_price;
                        cout<<"Enter New Quantity: ";cin>>new_qty;
                            id=new_id;
                            title=new_title;
                ...
                cout<<"Please Choose option:";cin>>option;
                    ...
                    {   
                        case 1 :{
                            ...
                            cout<<"2.Sort By Title [Z-A]"<<endl;
                            cout<<"Please Choose option:";cin>>answer;
                            check =false;
                            if(answer==1){
                                for(int i=0;i<size_of_book;i++){
